...
export default function MeetingReports() {
  ...
  // Get real data from store filtered by full context
  const records = appStore.getRecordsByContext(context.grade, context.subject, context.term);
  const actionPlans = appStore.getActionPlans();
  const interventionStats = appStore.getInterventionStats();
                                        ...
                                        <td className="p-5 text-center">
                                            <div className="flex flex-col items-center justify-center gap-1.5">
                                                ...
                                                <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full border ${
                                                    r.challengeLevel === ChallengeLevel.AC_PLUS 
